                        ...
                        k(
                            ...
                            bind(this, function (e) {
                                var o,
                                    ...
                                    r = this.map.name,
                                    n = this.map.parentMap
                                        ? this.map.parentMap.name
                                        : null,
                                    a = f.makeRequire(s.parentMap, {
            ...
            ((f = {
                ...
                nameToUrl: function (e, t, i) {
                    var r,
                        ...
                        s,
                        u = getOwn(b.pkgs, e);
                    if ((u = getOwn(m, (e = u ? u : e))))
                        return f.nameToUrl(u, t, i);
                    if (req.jsExtRegExp.test(e)) a = e + (t || "");
                    else {
                        for (
                            r = b.paths, o = (n = e.split("/")).length;
                            0 < o;
                            --o
                        )
